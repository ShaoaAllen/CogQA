...
from PowerGNN_model import BertForMultiHopQuestionAnswering, CognitiveGNN
...
from powerful_gnns.util import load_data, separate_data
...
def main(output_model_file = './models/pytorch_model.bin', load = True, mode = 'tensors', batch_size = 7,
    ...
    if load:
        ...
        model2 = GraphCNN(args.num_layers, args.num_mlp_layers, train_graphs[0].node_features.shape[1], args.hidden_dim,
