...
def main(output_model_file = './models/pytorch_model.bin', output_dir = './models/trans.bin' , load = 1, mode = 'tensors', batch_size = 1,
    ...
    if load == 2:
        ...
        model3 = CognitiveGNN(model1.config.hidden_size)
