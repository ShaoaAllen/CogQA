...
from transform_model import BertForMultiHopQuestionAnswering, CognitiveGNN, Transformer
...
def main(output_model_file = './models/pytorch_model.bin', output_dir = './models/trans.bin' , load = 3, mode = 'bundle', batch_size = 7,
    ...
    if load == 2:
        ...
        model3 = Transformer(opt.src_vocab_size, opt.trg_vocab_size, src_pad_idx=opt.src_pad_idx,
                             trg_pad_idx=opt.trg_pad_idx, trg_emb_prj_weight_sharing=opt.proj_share_weight,
                             emb_src_trg_weight_sharing=opt.embs_share_weight, d_k=opt.d_k, d_v=opt.d_v,
                             d_model=opt.d_model,
    ...
    if load == 1:
        ...
        model2 = CognitiveGNN(model1.config.hidden_size)
        print("7", model2, '\n')
        model3 = Transformer(opt.src_vocab_size,opt.trg_vocab_size,src_pad_idx=opt.src_pad_idx,trg_pad_idx=opt.trg_pad_idx,trg_emb_prj_weight_sharing=opt.proj_share_weight,emb_src_trg_weight_sharing=opt.embs_share_weight,d_k=opt.d_k,d_v=opt.d_v,
        d_model=opt.d_model,
        d_word_vec=opt.d_word_vec,
        d_inner=opt.d_inner_hid,
        n_layers=opt.n_layers,
