...
from run_fail_store.TGN_model_fail import BertForMultiHopQuestionAnswering, GraphAttentionEmbedding
...
from pytorch_geometric.torch_geometric.datasets import JODIEDataset
from pytorch_geometric.torch_geometric.nn import TGNMemory
from pytorch_geometric.torch_geometric.nn.models.tgn import (LastNeighborLoader, IdentityMessage,
                                           LastAggregator)
...
def main(output_model_file = './models/pytorch_model.bin', load = False, mode = 'tensors', batch_size = 7,
    ...
    if load:
        ...
        model2 = GraphAttentionEmbedding(
